...
from Utiles.util_imagenes import leer_imagen

root = tk.Tk()
root.title(TITULO)
icon = tk.PhotoImage(file="C:/Users/elmun/OneDrive/Documentos/pruebas python/Programacion1-2/Graficos/Imagenes/sales.png")#No se redimensiona
...
label = tk.Label(barra_superior,text="uf0c9",font=fontawesome)
label.pack(padx=10,pady=10)
fontawesome = font.Font(family="Font Awesome 7 Free",size=20)

btn_menu= tk.Button(barra_superior, text="\uf0c9",font=fontawesome,bg=COLOR_BARRA_SUPERIOR,fg="#f2f2f2",bd=0)
...
btn_stop= tk.Button(barra_superior, text="\uf04d",font=fontawesome,bg=COLOR_BARRA_SUPERIOR,fg="#f2f2f2",bd=0)


btn_play= tk.Button(barra_superior, text="\uf04b",font=fontawesome,bg=COLOR_BARRA_SUPERIOR,fg="#f2f2f2",bd=0)

btn_pause= tk.Button(barra_superior, text="\uf04c",font=fontawesome,bg=COLOR_BARRA_SUPERIOR,fg="#f2f2f2",bd=0)

volumen = tk.Scale(barra_superior, from_=0, to=100, bg=COLOR_BARRA_SUPERIOR,fg="#f2f2f2", bd=0,border=0, resolution=1,orient="horizontal")
